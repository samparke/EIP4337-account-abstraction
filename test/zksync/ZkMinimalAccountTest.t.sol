...
contract ZkMinimalAccountTest is Test, ZkSyncChainChecker {
    ...
    function testZkOwnerCanExecuteCommands() public {
        ...
        // we do not need a signature as we are calling from owner ('requireFromBootloaderOrOwner')
    ...
    function _createUnsignedTransaction(
        ...
        return Transaction({
            ...
            from: uint256(uint160(from)), // uint160 -> uint256: convert address into a uint256
